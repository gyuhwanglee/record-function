...
function ModalPivot({
  ...
  const handleSaveInventory = async e => {
    if (!isIncorrect) {
      const res = await orderInventoryUpdate(unixTime, dcId, {
        max_quantity: totalNumber,
        min_quantity: minimumNumber,
      });
      if (res.status === 200) {
        setIsSaveModal(!isSaveModal);
  ...
  useEffect(() => {
    if (detailData.length !== 0) {
      detailData &&
        detailData.options.inventories.map(el => {
          ...
          setOptionKeyDatas(resulstChange);
          setOptionValueDatas(values);
          setMinmumNumber(el.min);
          setTotalNumber(el.total);
        });
  ...
  return (
    <StaffListModalWrap isOpenModal={isOpenModal}>
      {isVoucherModal && (
        <VoucherModal
          handleCancelBtn={handleVoucherModal}
        ...
        <HeadBarWrapper>
          <div className="headBarTextWrapper">
            <div className="topWrapper">
              <div>Tour</div>
              <div className="IconWrap" onClick={handleClickCloseModal}>
                <CancelX onClick={handleClickCloseModal} />
              </div>
            </div>
                                ...
                                <ButtonWrapper isIncorrect={isIncorrect}>
                                  <div className="cancelButton">
                                    ...
                                    <Button
                                      ...
                                      buttonName="Cancle"
                                      isCheck={true}
                                      handleButtonClick={handleEditNumber}
                                      type="button"
                                    />
                                  </div>
                                  <div className="saveButton">
                                    ...
                                    <Button
                                      name="primarySmall"
                                      buttonName="Save"
                                      handleButtonClick={handleSaveModal}
                                      isCheck={true}
                                      type="button"
                                    />
                                  </div>
                      ...
                      <div className="headerBox">
                        <div className="selectBox">
                          ...
                          <div className="topBox">
                            ...
                            <span className="arrowBox">
                              {isOrderWrapper ? (
                                <ArrowBottom onClick={handleOrderWrapper} />
                              ) : (
                                <ArrowTop onClick={handleOrderWrapper} />
                              )}
                            </span>
                          </div>
                        </div>
